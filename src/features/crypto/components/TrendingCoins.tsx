...
export function TrendingCoins() {
  ...
  if (isLoading || !data) {
    return <div className="h-64 rounded-2xl animate-pulse" style={cryptoTheme.effects.glass} />;
  }
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        >
          <Flame className="w-5 h-5" style={{ color: cryptoTheme.colors.chart.quaternary }} />
        </div>
          ...
          return (
            ...
            >
              ...
              <button 
                onClick={(e) => {
                  e.stopPropagation();
                  isFav ? removeFromWatchlist(coin.id) : addToWatchlist(coin.id);
                }}
              ...
              <div className="flex-1">
                <p className="font-medium text-sm" style={{ color: cryptoTheme.colors.text.primary }}>
                  {coin.symbol}
                </p>
              ...
              <div className="text-xs font-medium" style={{ color: cryptoTheme.colors.text.secondary }}>
