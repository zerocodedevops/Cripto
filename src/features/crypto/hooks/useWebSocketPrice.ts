...
import { getWebSocketClient, BinanceTicker } from '../utils/websocketClient';
...
export function useWebSocketPrice({ coingeckoIds, enabled = true }: UseWebSocketPriceOptions) {
