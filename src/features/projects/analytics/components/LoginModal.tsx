...
import { premiumTypography, premiumLayout, premiumEffects } from '../utils/premiumTheme';
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="relative text-center mb-8">
              ...
              <h2 className="text-2xl font-bold mb-2" style={{ fontFamily: premiumTypography.fontFamily.display }}>
                Welcome Back
              </h2>
              <p className="text-sm opacity-40 uppercase tracking-widest font-medium">Access Analytics Workspace</p>
            </div>
