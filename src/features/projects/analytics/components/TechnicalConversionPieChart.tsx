...
export function TechnicalConversionPieChart({ data, isLoading, onSliceClick }: TechnicalConversionPieChartProps) {
  const { t } = useLanguage();
  if (isLoading) {
    return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-1 h-4" style={{ backgroundColor: technicalColors.electric.green }}></div>
          <h3 
        ...
        {/* Corner indicators */}
        <div className="absolute top-0 left-0 w-3 h-3 border-l border-t" style={{ borderColor: technicalColors.electric.green }}></div>
        <div className="absolute top-0 right-0 w-3 h-3 border-r border-t" style={{ borderColor: technicalColors.electric.green }}></div>
        <div className="absolute bottom-0 left-0 w-3 h-3 border-l border-b" style={{ borderColor: technicalColors.electric.green }}></div>
        <div className="absolute bottom-0 right-0 w-3 h-3 border-r border-b" style={{ borderColor: technicalColors.electric.green }}></div>
      </div>
    </motion.div>
  );
}
