...
export function PremiumSalesLineChart({
	data,
	isLoading,
	showComparison,
	onPointClick,
}: PremiumSalesLineChartProps) {
	const { t } = useLanguage();
					...
					>
						<defs>
							...
							>
								<stop
									offset="5%"
									stopColor={premiumColors.brand.primary}
									stopOpacity={0.3}
								/>
								<stop
									offset="95%"
							...
							>
								<stop
									offset="5%"
									stopColor={premiumColors.brand.tertiary}
									stopOpacity={0.3}
								/>
								<stop
									offset="95%"
						...
						<Area
							...
							dot={{
								r: 0,
								fill: premiumColors.brand.primary,
								strokeWidth: 2,
								stroke: "#fff",
							}}
							activeDot={{
						...
						<Area
							...
							dot={{
								r: 0,
								fill: premiumColors.brand.tertiary,
								strokeWidth: 2,
								stroke: "#fff",
							}}
							activeDot={{
