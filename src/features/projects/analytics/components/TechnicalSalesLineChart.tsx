...
export function TechnicalSalesLineChart({
	data,
	isLoading,
	showComparison,
	onPointClick,
}: TechnicalSalesLineChartProps) {
	const { t } = useLanguage();
	if (isLoading) {
		return (
			...
			>
				...
				<div className="flex justify-between items-center mb-4">
					<div className="flex items-center gap-3">
						<div
							className="w-1 h-4"
							style={{ backgroundColor: technicalColors.electric.blue }}
						></div>
						<h3
					...
					<div
						...
						style={{ fontFamily: technicalTypography.fontFamily.mono }}
					>
						<div className="flex items-center gap-1.5">
							<div
								...
								style={{ backgroundColor: technicalColors.electric.blue }}
							></div>
							<span style={{ color: technicalColors.electric.cyan }}>
								{t("sales")}
							</span>
						</div>
						{showComparison && (
							<div className="flex items-center gap-1.5 opacity-50">
								<div
									...
									style={{ borderColor: technicalColors.electric.blue }}
								></div>
								<span style={{ color: technicalColors.electric.cyan }}>
									{t("prev")}
								</span>
						...
						>
							<defs>
								...
								>
									<stop
										offset="5%"
										stopColor={technicalColors.electric.blue}
										stopOpacity={0.4}
									/>
									<stop
										offset="95%"
								...
								>
									<stop
										offset="5%"
										stopColor={technicalColors.electric.green}
										stopOpacity={0.4}
									/>
									<stop
										offset="95%"
