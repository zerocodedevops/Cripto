		...
		>
			...
			<div className="space-y-1">
				...
				{data.dropOff > 0 && (
					<p
						className="text-[10px]"
						style={{ color: technicalColors.status.error }}
					>
...
export function TechnicalRevenueBarChart({
	data,
	isLoading,
	onBarClick,
}: TechnicalRevenueBarChartProps) {
	const { t } = useLanguage();
	if (isLoading) {
		return (
		...
		>
			...
			>
				...
				<div className="flex justify-between items-center mb-4">
					<div className="flex items-center gap-3">
						<div
							className="w-1 h-4"
							style={{ backgroundColor: technicalColors.electric.amber }}
						></div>
						<h3
							...
							>
								{data.map((entry) => (
									<Cell
										...
										fill={
											FUNNEL_COLORS[data.indexOf(entry) % FUNNEL_COLORS.length]
										}
									/>
								))}
							</Bar>
            ...
            `,
				...
				<div
					...
					style={{ borderColor: technicalColors.electric.amber }}
				></div>
				<div
