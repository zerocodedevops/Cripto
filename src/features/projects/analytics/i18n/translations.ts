export const translations = {
  es: {
    ...
    subtitle: 'SISTEMA DE MONITOREO EN TIEMPO REAL // FLUJO DE DATOS MSW SIMULADO',
    ...
    positiveMomentumDesc: 'métricas mostrando tendencia alcista. El rendimiento es fuerte.',
    decliningMetrics: 'MÉTRICAS EN DECLIVE',
    decliningMetricsDesc: 'métricas con tendencia a la baja. Revisar estrategia.',
    ...
    acceleratingGrowthDesc: 'Ventas recientes 20% superiores al inicio del período. Momentum en construcción.',
  ...
  en: {
    ...
    positiveMomentumDesc: 'metrics showing upward trend. Performance is strong.',
    ...
    acceleratingGrowthDesc: 'Recent sales 20% higher than period start. Momentum building.',
