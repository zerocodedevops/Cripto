...
export class BinanceWebSocketClient {
  ...
  // Listener management
  addMessageListener(cb: MessageCallback) { this.messageListeners.push(cb); }
  removeMessageListener(cb: MessageCallback) { this.messageListeners = this.messageListeners.filter(l => l !== cb); }
  
  addConnectListener(cb: VoidCallback) { this.connectListeners.push(cb); }
  removeConnectListener(cb: VoidCallback) { this.connectListeners = this.connectListeners.filter(l => l !== cb); }
  
  addDisconnectListener(cb: VoidCallback) { this.disconnectListeners.push(cb); }
  removeDisconnectListener(cb: VoidCallback) { this.disconnectListeners = this.disconnectListeners.filter(l => l !== cb); }
  
  addErrorListener(cb: ErrorCallback) { this.errorListeners.push(cb); }
  removeErrorListener(cb: ErrorCallback) { this.errorListeners = this.errorListeners.filter(l => l !== cb); }
...
const ALL_APP_COINS = ['bitcoin', 'ethereum', 'cardano', 'solana', 'polkadot', 'dogecoin', 'avalanche', 'chainlink', 'polygon', 'litecoin'];
