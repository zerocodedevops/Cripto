          ...
          >
            <div>
              <div className="flex justify-between items-start mb-3">
                ...
                <span className="flex items-center gap-1 text-xs" style={{ color: cryptoTheme.colors.text.tertiary }}>
                  <Clock className="w-3 h-3" />
                  {news.time}
                </span>
              </div>
              
              <h4 className="font-bold text-sm mb-3 leading-relaxed group-hover:text-blue-400 transition-colors line-clamp-2" style={{ color: cryptoTheme.colors.text.primary }}>
                {news.title}
              </h4>
            </div>
