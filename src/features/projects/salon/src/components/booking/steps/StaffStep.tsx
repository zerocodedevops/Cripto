		...
		>
			<div className="flex items-center gap-4">
				...
				<div className="space-y-1">
					...
					<h2 className="text-2xl md:text-4xl font-baroque text-neutral-100">
						{t("selectStaff")}
					</h2>
				</div>
			</div>
			...
			<div className="grid grid-cols-2 md:grid-cols-3 gap-6">
				...
				>
					<div className="w-20 h-20 rounded-full bg-neutral-800 flex items-center justify-center border border-white/10 group-hover:border-gold-500 transition-colors">
						<span className="font-baroque text-xl text-neutral-400 group-hover:text-gold-500">
							?
						</span>
					</div>
					<span className="font-body text-sm font-bold text-neutral-300 group-hover:text-white uppercase tracking-wider">
						Any Specialist
					</span>
				</button>
				...
				{staff.map((s) => (
					...
					>
						<div className="w-20 h-20 rounded-full bg-neutral-800 flex items-center justify-center border border-white/10 overflow-hidden relative">
							...
							<span className="relative font-baroque text-xl text-neutral-400 group-hover:text-gold-500 z-10">
								{s.name.charAt(0)}
							</span>
						</div>
						<div className="text-center">
							<h3 className="font-body text-sm font-bold text-neutral-300 group-hover:text-white uppercase tracking-wider">
								{s.name}
							</h3>
