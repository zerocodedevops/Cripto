    ...
    if (status === 'error') {
        return (
            <div className="text-center space-y-4">
                ...
                <p className="text-neutral-400">Something went wrong creating your booking.</p>
        ...
        >
            {status === 'processing' ? (
                <div className="space-y-4">
                    ...
                    <p className="text-neutral-400 text-sm tracking-widest uppercase animate-pulse">Confirming reservation...</p>
                </div>
            ) : (
                <>
                    ...
                    <div className="space-y-2">
                        <h2 className="text-4xl md:text-5xl font-baroque text-gold-500">{t('success')}</h2>
                        <p className="font-mono text-neutral-500 tracking-widest uppercase">Ref: {bookingRef}</p>
                    </div>
