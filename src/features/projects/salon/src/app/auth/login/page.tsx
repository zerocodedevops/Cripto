	...
	return (
		<div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4">
			<div className="w-full max-w-md space-y-8">
				<Link
					href="/"
					className="inline-flex items-center text-neutral-500 hover:text-white transition-colors mb-8"
				>
				...
				<div className="bg-neutral-900 border border-white/10 p-8 rounded-sm shadow-2xl">
					<div className="text-center mb-8">
						<h1 className="font-baroque text-3xl text-gold-500 mb-2">
							ZERO | ADMIN
						</h1>
					...
					<form className="space-y-6">
						...
						<Link
							...
							className="block w-full bg-gold-600 text-black font-bold text-center py-3 uppercase tracking-widest hover:bg-gold-500 transition-colors"
						>
							Entrar
						</Link>
					</form>
