				...
				<div className="flex h-screen bg-neutral-900 text-neutral-200 font-sans">
					...
					<aside className="w-64 border-r border-white/10 bg-black/40 hidden md:flex flex-col">
						<div className="p-6 border-b border-white/10">
							<h1 className="text-xl font-heading text-gold-500 tracking-wider">
								ZERO | Admin
							</h1>
						</div>
						...
						<div className="p-4 border-t border-white/10">
							<Link
								href="/"
								className="flex items-center gap-3 px-4 py-3 text-neutral-400 hover:text-white hover:bg-white/5 rounded-md transition-colors"
							>
								<LogOut size={18} />
...
function NavItem({
	...
	return (
		<Link
			href={href}
			className="flex items-center gap-3 px-4 py-3 text-neutral-400 hover:text-gold-500 hover:bg-gold-500/10 rounded-md transition-colors group"
		>
