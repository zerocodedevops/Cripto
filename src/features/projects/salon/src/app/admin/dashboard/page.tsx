	...
	return (
		<div className="p-8 space-y-8">
			<header className="flex justify-between items-center">
				<h1 className="text-3xl font-heading text-[#FCF6BA] drop-shadow-md">
					Panel de Control
				</h1>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				<StatCard
					...
					subvalue={
						todayBookings.length > 0 ? "Actividad Alta" : "Sin actividad"
					}
				/>
				<StatCard
					label="Ingresos (Est.)"
			...
			<div className="space-y-4">
				<h2 className="text-xl font-heading text-[#BF953F] border-b border-[#BF953F]/20 pb-2">
...
function StatCard({
	...
	return (
		<div className="bg-gradient-to-br from-neutral-900 to-black border border-[#BF953F]/20 p-6 rounded-sm shadow-lg group hover:border-[#BF953F]/50 transition-colors">
			<h3 className="text-[#BF953F] text-xs font-bold uppercase tracking-widest mb-2">
				{label}
			</h3>
			<div className="text-4xl font-heading text-[#FCF6BA] mb-1">{value}</div>
			<p className="text-neutral-600 text-xs font-mono group-hover:text-[#BF953F]/70 transition-colors">
				{subvalue}
			</p>
		</div>
	);
