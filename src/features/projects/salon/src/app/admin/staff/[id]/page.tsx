    ...
    return (
        <div className="p-8 space-y-8 max-w-4xl mx-auto">
            <header>
                ...
                <p className="text-neutral-400 font-mono text-sm tracking-wider uppercase">Gestionar Disponibilidad</p>
            </header>

            <AvailabilityEditor staffId={staff.id} initialSchedule={staff.schedules} />
        </div>
    );
}
