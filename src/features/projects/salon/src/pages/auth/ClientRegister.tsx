            ...
            <div className="bg-slate-900 border border-slate-800 p-8 rounded-xl shadow-2xl w-full max-w-md relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-100 mb-2">Crear Cuenta</h2>
                        <p className="text-slate-400 text-sm text-center">Únete a Zero Vanity para gestionar tus reservas</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        <div>
                            <label className="block text-slate-400 text-xs uppercase font-bold mb-1.5 ml-1">Nombre Completo</label>
                            <input
                                type="text"
                                value={fullName}
                    ...
                    <div className="mt-6 text-center text-sm text-slate-500">
                        ¿Ya tienes cuenta?{' '}
                        <Link to="/proyectos/salon/login" className="text-amber-400 hover:text-amber-300 font-medium transition-colors">
                            Inicia Sesión
                        </Link>
                    </div>
                </div>
