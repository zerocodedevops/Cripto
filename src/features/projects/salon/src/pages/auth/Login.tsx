				...
				<form onSubmit={handleLogin} className="space-y-6">
					<div className="space-y-4">
						<div className="relative group">
							<Mail
								className="absolute left-3 top-3 text-[#BF953F]/50 group-focus-within:text-[#BF953F] transition-colors"
								size={18}
							/>
							<input
								type="email"
					...
					<button
						type="submit"
						className="w-full bg-[#BF953F] hover:bg-[#a67c2e] text-black font-bold py-3 uppercase tracking-widest text-xs transition-all"
					>
						Entrar
					</button>
				</form>
