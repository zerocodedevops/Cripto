        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
            <div className="bg-slate-900 border border-slate-800 p-8 rounded-xl shadow-2xl w-full max-w-md">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-slate-100 mb-2">Acceso Administrativo</h2>
                    <p className="text-slate-400 text-sm">Introduce tus credenciales para continuar</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    <div>
                        <label htmlFor="email" className="block text-slate-400 text-xs uppercase font-bold mb-1.5 ml-1">Email</label>
                        <input
                            id="email"
                            type="email"
                            value={email}
                    ...
                    <div>
                        <label htmlFor="password" className="block text-slate-400 text-xs uppercase font-bold mb-1.5 ml-1">Contraseña</label>
                        <input
                            id="password"
                            type="password"
                            value={password}
