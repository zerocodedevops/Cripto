        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-white font-medium">La robustez del código</span> con la <span className="text-accent-400 font-medium">velocidad del diseño visual</span>.
            </motion.p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-dark-900/80 backdrop-blur-xl border border-dark-700 rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="flex items-center gap-2 px-4 py-3 bg-dark-800/50 border-b border-dark-700">
                  ...
                  <span className="ml-2 text-dark-500 text-sm font-mono">developer.js</span>
                </div>
