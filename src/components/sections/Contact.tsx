          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-dark-400 text-xs uppercase tracking-wider font-medium mb-0.5">Email</p>
                  <p className="text-white font-medium">zerocode.devops@gmail.com</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-dark-900/50 border border-dark-700/50 hover:border-primary-500/30 transition-all group">
                ...
                <div>
                  <p className="text-dark-400 text-xs uppercase tracking-wider font-medium mb-0.5">Ubicación</p>
              ...
              >
                ...
                <div>
                  <p className="text-dark-400 text-xs uppercase tracking-wider font-medium mb-0.5">LinkedIn</p>
              ...
              >
                ...
                <div>
                  <p className="text-dark-400 text-xs uppercase tracking-wider font-medium mb-0.5">GitHub</p>
            ...
            <div className="rounded-lg bg-dark-950/80 border border-dark-700/50 overflow-hidden font-mono text-sm leading-relaxed shadow-lg">
              ...
              <div className="p-4 space-y-2">
                ...
                <div className="flex gap-2 pl-4">
                  ...
                  <span className="text-green-400 font-medium">Open for new projects</span>
                </div>
                ...
                <div className="flex gap-2 pl-4">
                  ...
                  <span className="text-primary-400 font-medium">Usually within 24 hours</span>
                </div>
              </div>
            </div>
          </motion.div>
