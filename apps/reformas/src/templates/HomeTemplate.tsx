        ...
        <RootLayout>
                ...
                <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10 pt-20">
                    <div className="flex flex-col justify-center animate-fade-in-up">
                        ...
                        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
                            <CTAButton text="Pide Presupuesto real" href="/contacto" variant="primary" />
                            <CTAButton text="Ver Proyectos" href="/proyectos" variant="outline" />
                        </div>
                        ...
                        {servicios.map((servicio) => (
                            <div key={servicio.id} className="group bg-white p-10 shadow-sm hover:shadow-2xl transition-all duration-500 border-b-4 border-transparent hover:border-[#D4A853]">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <Link to={`/${servicio.slug}`} className="text-[#D4A853] font-bold uppercase text-sm tracking-widest group-hover:translate-x-2 transition-transform">Ver más →</Link>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <ProcessSteps />
                    <div className="mt-16">
                        <CTAButton text="Descarga nuestra guía de proceso" variant="outline" />
                    </div>
                </div>
            </section>
        </RootLayout>
...
// Simple Link placeholder till we have routes correctly set up internally
