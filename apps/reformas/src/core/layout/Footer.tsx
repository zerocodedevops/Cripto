            ...
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-white/10 pb-16">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm text-gray-400">
                        <li><Link to="/reformas-integrales-madrid" className="hover:text-[#D4A853]">Reformas Integrales</Link></li>
                        <li><Link to="/reformas-cocinas-madrid" className="hover:text-[#D4A853]">Reformas de Cocinas</Link></li>
                        <li><Link to="/reformas-banos-madrid" className="hover:text-[#D4A853]">Reformas de Baños</Link></li>
                        <li><Link to="/proyectos" className="hover:text-[#D4A853]">Proyectos Antes/Después</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm text-gray-400">
                        <li><Link to="/reformas-madrid/salamanca" className="hover:text-[#D4A853]">Bº Salamanca</Link></li>
                        <li><Link to="/reformas-madrid/chamberi" className="hover:text-[#D4A853]">Chamberí</Link></li>
                        <li><Link to="/reformas-madrid/pozuelo" className="hover:text-[#D4A853]">Pozuelo de Alarcón</Link></li>
                        <li><Link to="/reformas-madrid/majadahonda" className="hover:text-[#D4A853]">Majadahonda</Link></li>
                    </ul>
                </div>
